...
usage()
{
	echo "
Usage :
./update_PMFconfig_properties.sh [-help] [propFile=<path to env.properties files>] 

Where:
propFile : Path to env.properties file 

Eg:
./update_PMFconfig_properties.sh 

./update_PMFconfig_properties.sh -propFile=/path/to/file/env.properties
...
echo
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo " 		Script to update PMFconfig.properties"
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo
...
pmfConfProf="${pfsHome}/jboss-5.1.0.GA/server/default/conf/PMFconfig.properties"


if [ ! -r "${pmfConfProf}" ]
then
	echo
	echo "ERROR: Unable to read PMFconfig.properties at  ${pmfConfProf}" 
	echo
	exit 1
fi

### Let us update the file now

getKeyValue "$propFile" "pfs.hostname" 
pfsHost=$value
updatePairValue "$pmfConfFile" "systemName" "$pfsHost"
